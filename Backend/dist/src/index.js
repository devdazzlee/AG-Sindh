...
const outgoingRoutes_1 = __importDefault(require("./routes/outgoingRoutes/outgoingRoutes"));
const notificationRoutes_1 = __importDefault(require("./routes/notificationRoutes/notificationRoutes"));
const letterTrackingRoutes_1 = __importDefault(require("./routes/letterTrackingRoutes/letterTrackingRoutes"));
