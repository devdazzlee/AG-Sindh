...
interface RecordDetailsModalProps {
  isOpen: boolean;
  onClose: () => void;
  record: any; // Consider defining a more specific type for 'record'
...
export function RecordDetailsModal({
  ...
  return (
    <Dialog  open={isOpen} onOpenChange={onClose}>
      <DialogContent className="w-full max-w-full sm:max-w-lg md:max-w-2xl lg:max-w-6xl max-h-[95vh] overflow-y-auto p-0">
        <DialogHeader className="px-6 py-4 border-b bg-gradient-to-r from-blue-50 to-indigo-50">
          <DialogTitle className="flex flex-col sm:flex-row items-start sm:items-center gap-3 text-xl font-bold text-gray-800">
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between p-4 bg-white rounded-xl border shadow-sm">
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-2">
              ...
              <div className="flex items-center gap-2 mt-2 sm:mt-0">
                ...
                <Badge
                  variant={getPriorityColor(record.priority)}
                  className="px-3 py-1"
                >
                  {record.priority}
                </Badge>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      {record.dispatchedDate && (
                        <div className="space-y-2">
                          ...
                          <div className="p-3 bg-gray-50 border rounded-lg">
                            <p className="text-sm font-medium text-gray-800">
                              {formatDate(record.dispatchedDate)}
                            </p>
                          </div>
                        </div>
                      )}
                      {record.deliveredDate && (
                        <div className="space-y-2">
                          ...
                          <div className="p-3 bg-gray-50 border rounded-lg">
                            <p className="text-sm font-medium text-gray-800">
                              {formatDate(record.deliveredDate)}
                            </p>
                          </div>
                        </div>
                      )}
                  ...
                  {isTrackingRecord &&
                    ...
                    record.collectedDate && (
                      <div className="space-y-2">
                        ...
                        <div className="p-3 bg-gray-50 border rounded-lg">
                          <p className="text-sm font-medium text-gray-800">
                            {formatDate(record.collectedDate)}
                          </p>
                        </div>
                      </div>
                    )}
            ...
            {/* Right Column - Document Image and Quick Stats */}
                    ...
                    <div className="flex flex-col items-center justify-center h-[400px] bg-gradient-to-br from-gray-50 to-gray-100 border-2 border-dashed border-gray-300 rounded-lg">
                      <div className="text-center p-6">
                        ...
                        <p className="text-sm text-gray-500">
                          This record doesn't have an attached document image
                        </p>
                      </div>
                    </div>
                  )}
