...
export function IncomingTab({ userRole }: IncomingTabProps) {
  ...
  const handleScanQR = async () => {
    ...
    try {
      ...
      const scannedCode =
        "QR" + Math.random().toString(36).substr(2, 6).toUpperCase();
    ...
    try {
      ...
      if (error.response?.status === 404) {
        toast({
          ...
          description:
            "No incoming letter found with this QR code. Please check the QR code and try again.",
          variant: "destructive",
        });
      } else {
        toast({
          ...
          description:
            ...
            "Failed to collect letter. Please try again.",
          variant: "destructive",
        });
      }
    } finally {
    ...
    try {
      ...
      toast({
        ...
        description:
          ...
          "Failed to save incoming letter",
        variant: "destructive",
      });
    } finally {
  ...
  const handleGenerateQRAndSave = async () => {
    ...
    <head>
      ...
      <style>
        /* 1) define the paper size and zero margins */
        @page {
          size: 50mm 50mm;
          margin: 0;
        }

        /* 2) reset body so it only contains the sticker */
        body {
          margin: 0;
          padding: 0;
        }

        /* 3) sticker container exactly 50mm square */
        .qr-sticker {
          width: 50mm;
          height: 50mm;
          display: flex;
        ...
        /* 4) the QR itself sized to fit inside */
        .qr-sticker img {
          width: 40mm;
          height: 40mm;
        }
      ...
      <div className="space-y-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Scan the QR code from RD Department to collect your assigned
              letter
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            ...
            <div className="p-8 border-2 border-dashed border-gray-300 rounded-lg text-center bg-gradient-to-br from-gray-50 to-gray-100">
              <div className="max-w-sm mx-auto">
                ...
                <p className="text-gray-600 mb-3">
                  Point your camera at the QR code on the incoming letter
                </p>
            ...
            {scannedLetter?.status === "COLLECTED" ? (
              ...
              <div className="p-6 bg-gradient-to-r from-gray-50 to-gray-100 border border-gray-200 rounded-lg text-center">
                ...
                <h3 className="text-lg font-semibold text-gray-800 mb-2">
                  Letter Already Archived
                </h3>
                <p className="text-sm text-gray-700 mb-4">
                  This letter has been archived and is no longer available for
                  collection.
                </p>
                <Button
                  variant="outline"
              ...
              <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
                <div className="text-center mb-4">
                  ...
                  <p className="text-xs text-green-700">
                    This letter can be marked as collected
                  </p>
                </div>
                <Button
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
        <Card className="xl:col-span-1">
          <CardHeader>
            ...
            <CardDescription>
              Scan or upload letter and fill the required information
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                ...
                <CardDescription>
                  List of recently added incoming letters
                </CardDescription>
              </div>
              <Button
                size="sm"
                ...
                {incomingRecords.length === 0 ? (
                  ...
                  incomingRecords.slice(0, 3).map((record) => (
                    ...
                    >
                      ...
                      <p
                        className="text-sm text-gray-600 truncate"
                        title={record.department?.name || "Unknown Department"}
                      >
